...
def remove_punct(text):
    ...
    'goSouTh'
    """
    for pos in range(len(string.punctuation)):
        text = text.replace(string.punctuation[pos], "")
...
def normalise_input(user_input):
    ...
    'help'
    """
    formated_input = remove_punct(user_input)

    formated_input = formated_input.lower()
    formated_input = remove_spaces(formated_input)
...
def menu(exits):
    ...
    while not Stop:
        ...
        formated_input = normalise_input(user_input)

        if is_valid_exit(exits, formated_input):
            return formated_input
            Stop = True
